...
## Initial Request — 2026-09-02T23:12:09+07:00

You are the Project Orchestrator for ToolHunt Enterprise Audit.
Your working directory is: c:\Users\Admin\Desktop\Projects\Tools\ToolHunt\.agents\orchestrator
...
Deliverables:
- `AUDIT_REPORT.md` at root with structured sections, classified by severity (Critical, High, Medium, Low), concrete evidence (file paths, code snippets, risk analysis, PoC/edge cases, and serverless/GAS-tailored remediation).
- Maintain `progress.md` and `BRIEFING.md` in your working directory.
- Report back when the task is complete.
